...
import { Card, Descriptions, Space, Tabs, Typography, Image } from 'antd';
...
export default function MediaDetail({ record, loading }: MediaDetailProps) {
  ...
  if (!record && !loading) {
    return <div>미디어 정보를 찾을 수 없습니다.</div>;
  }
