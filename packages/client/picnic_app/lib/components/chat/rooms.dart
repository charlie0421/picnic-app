...
import 'package:picnic_app/components/chat/auth.dart';
import 'package:picnic_app/components/chat/chat.dart';
...
class _RoomsPageState extends State<RoomsPage> {
  ...
  Widget build(BuildContext context) {
    logger.d('RoomsPage: build');
    logger.d('RoomsPage: _error: $_error');
    logger.d('RoomsPage: _initialized: $_initialized');
      ...
      body: _user == null
          ...
          : StreamBuilder<List<types.Room>>(
              ...
              builder: (context, snapshot) {
                logger.d('RoomsPage: snapshot: ${snapshot.data}');
