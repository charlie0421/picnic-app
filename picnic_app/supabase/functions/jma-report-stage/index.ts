...
const STAGING_DOMAIN = 'https://lite-be.ivideocloud.cn'
const AUTH_ENDPOINT = '/api/v1/access_token'
const VOTE_REPORT_ENDPOINT = '/api/v1/vote-report/picnic'

// Staging API 키 정보 (하드코딩)
const API_KEY = 'n8908ab0-83b2-31eb-43ac-788ee0e2a4hh'
const API_SECRET = 'M23YOVLvkRPOjJW5vM5tc33jF1LAbMSOFt7dEJkl'
...
async function getAccessToken(): Promise<string> {
  const url = `${STAGING_DOMAIN}${AUTH_ENDPOINT}`
...
serve(async (req) => {
  ...
  try {
    ...
    const updateUrl = `${STAGING_DOMAIN}${VOTE_REPORT_ENDPOINT}`
