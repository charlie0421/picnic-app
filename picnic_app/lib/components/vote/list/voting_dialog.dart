        ...
        content: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                border: Border.all(
                  color: _isOver ? AppColors.StatusError : AppColors.Primary500,
                  width: 1,
                ),
              ...
              onTap: () async {
                ...
                if (voteAmount == 0) {
                  ...
                  showSimpleDialog(
                    ...
                    content:
                        Intl.message('text_dialog_vote_amount_should_not_zero'),
                    onOk: () {},
                  );
                  return;
                }
                ...
                try {
                  ...
                  ref
                      .read(
                          asyncVoteItemListProvider(voteId: widget.voteModel.id)
                              .notifier)
                  ...
                  logger.e('exception.message: ${exception.reasonPhrase}');
                  logger.e('투표 실패: $e\n $stackTrace');
                  showSimpleDialog(
                    context: context,
                    title: Intl.message('dialog_title_vote_fail'),
