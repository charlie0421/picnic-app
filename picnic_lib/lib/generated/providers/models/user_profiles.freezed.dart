...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,nickname,avatarUrl,countryCode,deletedAt,userAgreement,isAdmin,isSuperAdmin,starCandy,starCandyBonus,jmaCandy,birthDate,gender,birthTime);

@override
String toString() {
  return 'UserProfilesModel(id: $id, nickname: $nickname, avatarUrl: $avatarUrl, countryCode: $countryCode, deletedAt: $deletedAt, userAgreement: $userAgreement, isAdmin: $isAdmin, isSuperAdmin: $isSuperAdmin, starCandy: $starCandy, starCandyBonus: $starCandyBonus, jmaCandy: $jmaCandy, birthDate: $birthDate, gender: $gender, birthTime: $birthTime)';
}
...
/// Create a copy of UserProfilesModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? nickname = freezed,Object? avatarUrl = freezed,Object? countryCode = freezed,Object? deletedAt = freezed,Object? userAgreement = freezed,Object? isAdmin = freezed,Object? isSuperAdmin = freezed,Object? starCandy = freezed,Object? starCandyBonus = freezed,Object? jmaCandy = freezed,Object? birthDate = freezed,Object? gender = freezed,Object? birthTime = freezed,}) {
...
as bool?,isSuperAdmin: freezed == isSuperAdmin ? _self.isSuperAdmin : isSuperAdmin // ignore: cast_nullable_to_non_nullable
...
switch (_that) {
case _UserProfilesModel() when $default != null:
return $default(_that.id,_that.nickname,_that.avatarUrl,_that.countryCode,_that.deletedAt,_that.userAgreement,_that.isAdmin,_that.isSuperAdmin,_that.starCandy,_that.starCandyBonus,_that.jmaCandy,_that.birthDate,_that.gender,_that.birthTime);case _:
  return orElse();
