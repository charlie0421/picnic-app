...
_ArtistModel _$ArtistModelFromJson(Map<String, dynamic> json) => $checkedCreate(
  '_ArtistModel',
  json,
  ($checkedConvert) {
    final val = _ArtistModel(
...
Map<String, dynamic> _$ArtistModelToJson(_ArtistModel instance) =>
    <String, dynamic>{
      ...
      'mm': instance.mm,
      'dd': instance.dd,
      'birth_date': instance.birthDateRaw?.toIso8601String(),
