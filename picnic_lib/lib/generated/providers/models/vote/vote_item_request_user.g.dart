...
_VoteItemRequestUser _$VoteItemRequestUserFromJson(Map<String, dynamic> json) =>
    $checkedCreate(
      '_VoteItemRequestUser',
      json,
      ($checkedConvert) {
        final val = _VoteItemRequestUser(
...
Map<String, dynamic> _$VoteItemRequestUserToJson(
  _VoteItemRequestUser instance,
) => <String, dynamic>{
  'id': instance.id,
