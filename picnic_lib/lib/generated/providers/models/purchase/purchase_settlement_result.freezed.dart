...
@JsonKey(name: 'currency') String? get currency;/// Amount actually paid, in major units, when the provider attested one.
///
...
@JsonKey(name: 'value')@PurchaseRevenueValueConverter() num? get value;/// How *this* client came to see a `replayed` settlement. Never part of the
...
/// value. Only meaningful paired with [currency] — an amount without a
/// currency is a candidate, never a revenue figure.
@override@JsonKey(name: 'value')@PurchaseRevenueValueConverter() final  num? value;
