...
_CommentModel _$CommentModelFromJson(
  Map<String, dynamic> json,
) => $checkedCreate(
  '_CommentModel',
  json,
  ($checkedConvert) {
    final val = _CommentModel(
      ...
      isReportedByMe: $checkedConvert('is_reported_by_me', (v) => v as bool?),
      isBlindedByAdmin: $checkedConvert(
        'is_blinded_by_admin',
        (v) => v as bool?,
      ),
      ...
      parentCommentId: $checkedConvert(
        'parent_comment_id',
        (v) => v as String?,
      ),
