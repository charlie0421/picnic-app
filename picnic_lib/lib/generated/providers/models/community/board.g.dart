...
_BoardModel _$BoardModelFromJson(Map<String, dynamic> json) => $checkedCreate(
  '_BoardModel',
  json,
  ($checkedConvert) {
    final val = _BoardModel(
      ...
      description: $checkedConvert(
        'description',
        (v) => const DescriptionConverter().fromJson(v),
      ),
      ...
      artist: $checkedConvert(
        'artist',
        (v) =>
            v == null ? null : ArtistModel.fromJson(v as Map<String, dynamic>),
      ),
      requestMessage: $checkedConvert('request_message', (v) => v as String?),
