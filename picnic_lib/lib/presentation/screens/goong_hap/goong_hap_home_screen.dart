...
class GoongHapHomeScreen extends ConsumerStatefulWidget {
  const GoongHapHomeScreen({super.key});

  @override
  ConsumerState<GoongHapHomeScreen> createState() =>
      _GoongHapHomeScreenState();
}

class _GoongHapHomeScreenState extends ConsumerState<GoongHapHomeScreen> {
