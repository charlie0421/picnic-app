  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: GestureDetector(
        ...
        child: Text(
            '${AppLocalizations.of(context).label_read_more_comment} ${ref.watch(commentCountProvider(widget.article.id)).value != 0 ? ref.watch(commentCountProvider(widget.article.id)).value : widget.article.commentCount}',
            style: getTextStyle(
              AppTypo.body14B,
              AppColors.grey900,
            )),
