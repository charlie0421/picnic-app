...
class VoteItemHighlightWidget extends StatelessWidget {
  ...
  final bool isEnded;
  final bool isSaving;
  final Set<int> highlightedItemIds;
  final VoidCallback onTap;
  final Widget artistImage;
  final Widget voteCountContainer;
  final String Function(Map<String, dynamic>, String) getMatchingText;
  final String rankText;

  const VoteItemHighlightWidget({
    super.key,
    required this.item,
    required this.index,
  ...
  Widget build(BuildContext context) {
    try {
      final bool highlightActive = highlightedItemIds.contains(item.id);
      ...
      return VoteItemWidget(
        ...
        voteCountContainer: voteCountContainer,
        rankText: rankText,
      );
    }
  }
